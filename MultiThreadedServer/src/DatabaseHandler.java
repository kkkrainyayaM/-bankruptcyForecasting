...
public class DatabaseHandler extends Configs {
    ...
    public String getCompanies(String userId){
        ...
        try {
            ...
            PreparedStatement prep1 = getDbConnection().prepareStatement( selectFirst );
            ResultSet rs1 = prep1.executeQuery();
            while (rs1.next()){
                int id = rs1.getInt( "IDCompany" );
                String select = "SELECT * FROM app.company WHERE IDCompany=" + id;
                PreparedStatement prep = getDbConnection().prepareStatement( select);
    ...
    public void addReport(Report report, int IDUser){
        ...
        try {
            ...
            String insert2 = "INSERT INTO "+ Const.USERREPORT_TABLE+"("+
                    ...
                    "VALUES(?,?)";
            PreparedStatement prep = getDbConnection().prepareStatement( insert2 );
    ...
    public String getReportsCompany(String companyId) {
        ...
        try {
            prep = getDbConnection().prepareStatement(select);
    ...
    public void addUSD(String newRate) throws JSONException, SQLException, ClassNotFoundException {
        ...
        String insert = "INSERT INTO "+ Const.USD_TABLE +"("+
                ...
                "VALUES(?,?,?,?,?)";
        PreparedStatement prSt = getDbConnection().prepareStatement(insert);
        prSt.setDouble(1, usd.getUSDBYN());
        prSt.setDouble(2, usd.getUSDEUR());
        prSt.setDouble(3, usd.getUSDRUB());
        prSt.setInt( 4, usd.getId() );
    ...
    public void deleteUser(String userId) throws SQLException, ClassNotFoundException {
        String deletion = "DELETE FROM app.user WHERE "+ Const.USERS_ID +"="+ userId;
        PreparedStatement prep = null;
        prep = getDbConnection().prepareStatement(deletion);
        prep.executeUpdate();
    }

    public Report getLastReport() throws SQLException, ClassNotFoundException {
